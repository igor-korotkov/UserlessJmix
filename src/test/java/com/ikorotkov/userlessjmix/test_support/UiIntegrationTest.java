package com.ikorotkov.userlessjmix.test_support;

import com.ikorotkov.userlessjmix.UserlessJmixApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "UJ_MainScreen", screenBasePackages = "com.ikorotkov.userlessjmix.screen")
@ContextConfiguration(classes = {UserlessJmixApplication.class, UiTestAssistConfiguration.class})
